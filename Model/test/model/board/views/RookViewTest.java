...
public class RookViewTest {

    private RankView w_rookView_e_4 = null;
    private RankView b_rookView_e_4 = null;
    ...
    private final Square a_4 = new Square(Column.A, Row.R4);
    private final Square b_4 = new Square(Column.B, Row.R4);
    private final Square e_1 = new Square(Column.E, Row.R1);
    private final Square h_4 = new Square(Column.H, Row.R4);
    private final Square e_8 = new Square(Column.E, Row.R8);
    private final Square e_7 = new Square(Column.E, Row.R7);
    ...
    public void it_finds_squares_holding_pieces_attacked() {
        ...
        w_rookView_e_4 = new RookView(position_e_4, Color.WHITE);

        List<Square> squaresHoldingPiecesAttacked = w_rookView_e_4.squaresHoldingPiecesAttacked();
    ...
    public void it_finds_squares_holding_pieces_defended() {
        ...
        b_rookView_e_4 = new RookView(position_e_4, Color.BLACK);

        List<Square> squaresHoldingPiecesDefended = b_rookView_e_4.squaresHoldingPiecesDefended();
    ...
    public void it_finds_move_to_squares() {
        ...
        List<Square> moveToSquares = w_rookView_e_4.moveToSquares();

        assertThat(moveToSquares.size(), equalTo(14));
    ...
    public void it_finds_threatened_squares() {
        ...
        List<Square> threatenedSquares = w_rookView_e_4.threatenedSquares();
        assertThat(threatenedSquares.size(), equalTo(14));
