...
public class PawnViewTest {
    ...
    private final Square e_4 = new Square(Column.E, Row.R4);
    ...
    public void setUp() {
        ...
        position_e_2 = new BoardPosition(chessBoard, new Square(Column.E, Row.R4));
    }

    @Test
    public void it_finds_squares_holding_pieces_attacked() {
        chessBoard = putBlackPawnsInBoxAround_E_4();
        position_e_2 = new BoardPosition(chessBoard, new Square(Column.E, Row.R2));
    ...
    public void it_finds_squares_holding_pieces_defended() {
        ...
        BoardPosition position_e_7 = new BoardPosition(chessBoard, new Square(Column.E, Row.R7));
    ...
    public void it_finds_move_to_squares() {
        chessBoard = chessBoard.playEvent(new PutEvent(PieceFactory.newPiece(Rank.Pawn, Color.WHITE, e_2)));
        position_e_2 = new BoardPosition(chessBoard, new Square(Column.E, Row.R2));
