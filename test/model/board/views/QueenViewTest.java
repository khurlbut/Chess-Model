...
public class QueenViewTest {
    ...
    private RankView w_queenView_e_4 = null;
    private RankView b_queenView_e_4 = null;
    ...
    private final Square h_7 = new Square(Column.H, Row.R7);
    private final Square h_4 = new Square(Column.H, Row.R4);
    private final Square h_1 = new Square(Column.H, Row.R1);
    private final Square b_1 = new Square(Column.B, Row.R1);
    private final Square e_1 = new Square(Column.E, Row.R1);
    private final Square b_7 = new Square(Column.B, Row.R7);
    private final Square a_8 = new Square(Column.A, Row.R8);
    ...
    public void it_finds_squares_holding_pieces_attacked() {
        ...
        w_queenView_e_4 = new QueenView(position_e_4, Color.WHITE);
    ...
    public void it_finds_squares_holding_pieces_defended() {
        ...
        b_queenView_e_4 = new QueenView(position_e_4, Color.BLACK);
