...
import static model.board.views.ViewSugar.rookView;
...
public class RookViewTest {
    ...
    private RookView w_rookView_e_4 = null;
    private RookView b_rookView_e_4 = null;
    ...
    public void setUp() {
        ...
        w_rookView_e_4 = newRookView(Color.WHITE, Column.E, Row.R4);
    }
    ...
    public void it_finds_squares_holding_pieces_defended() {
        ...
        b_rookView_e_4 = newRookView(Color.BLACK, Column.E, Row.R4);
    ...
    public RookView newRookView(Color color, Column column, Row row) {
        return rookView(color, column, row, chessBoard);
    }
